...
public class TelaCliente extends javax.swing.JFrame {
    ...
    private void setIcon(){
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("../imagens/user_orange.png")));
    }
   ...
   public void selecionarItem(){
       ...
       txtEndereco.setText(tblCliente.getValueAt(tblCliente.getSelectedRow(), 6).toString());
       txtCep.setText(tblCliente.getValueAt(tblCliente.getSelectedRow(), 7).toString());
 ...
 public void limpar () throws SQLException{
   ...
   // habilitar os botões adicionar e buscar
    ...
    private void initComponents() {
        ...
        jLabel9.setText("RG");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 200, -1, -1));
        ...
        jPanel1.add(txtEndereco, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 150, 260, -1));
        jPanel1.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 220, 300, -1));
        ...
        tblCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Telefone", "Email", "RG", "CPF", "Endereço", "Cep"
            }
        ));
        ...
        jPanel1.add(txtCep, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, 110, -1));
        ...
        jPanel1.add(txtRg, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 220, 90, -1));
        ...
        jPanel1.add(txtCpf, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 220, 120, -1));
